      ...
      (context,index ){
        return Padding(
          ...
          child: Container(height: 200,width: 50,decoration: BoxDecoration(border: Border.all(
            color:index==0? Colors.cyan :index==9?Colors.pink:index %2==0?Colors.blueAccent:
              ...
              Center(
                child: Column(
                  children: [
                    ...
                    color:index==0?Colors.white: index == 9 ? Colors.cyan:
                     index==4?Colors.green: Colors.black),),
                     Text("Zainab",style: TextStyle(fontSize: 50,fontWeight: FontWeight.bold,
                    color:index==0?const Color.fromARGB(255, 192, 189, 189): index == 9 ? const Color.fromARGB(255, 50, 161, 152):index==4?Colors.green: Colors.black),),
                  ],
                ),
              ),
              // Row(
