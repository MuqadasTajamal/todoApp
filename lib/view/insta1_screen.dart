      ...
      body: Row(
        ...
        children: [
            ...
            child: Column(
              ...
              children: [
                Text(
                  "Instagram",
                  style: TextStyle(
                      fontFamily: "Satify", color: MyColors.whitecolor, fontSize: 25),
                ),
                SizedBox(
                  height: 20,
                ),
          ...
          Container(
            ...
            width: 1,
            decoration: BoxDecoration(border: Border.all(color: MyColors.whitecolor)),
          ),
          Padding(
              ...
              children: [
                Row(
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        RichText(
                          ...
                          TextSpan(
                              text: "_", style: TextStyle(color:MyColors.whitecolor)),
                          TextSpan(
                              text: "s", style: TextStyle(color:MyColors.whitecolor)),
                          TextSpan(
                              text: "_", style: TextStyle(color:MyColors.whitecolor)),
                          TextSpan(
                              text: "marshmallow",
                    ...
                    Text("switch", style: TextStyle(color: MyColors.bluecolor)),
                  ],
                ),
                SizedBox(
                  height: 20,
                ...
                Row(
                  children: [
                    ...
                    Text(
                      "See All",
                      style: TextStyle(color: MyColors.whitecolor, fontSize: 12),
                    ),
                  ],
                ),
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Text("laiba",
                            style: TextStyle(color: MyColors.whitecolor)),
                    Text("Followed", style: TextStyle(color: MyColors.whitecolor)),
                    ...
                    Text("Follow", style: TextStyle(color: MyColors.bluecolor)),
                  ],
                ),
 ...
 SizedBox(
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Text(" bilal abbas",
                            style: TextStyle(color: MyColors.whitecolor)),
                    Text("Follow", style: TextStyle(color:  MyColors.whitecolor)),
                ...
                Row(
                  children: [
                    ...
                    Row(
                      children: [
                        Text("arsalnaiqbal", style: TextStyle(color:  MyColors.whitecolor)),
                        SizedBox(width: 4,),
                      CircleAvatar(radius:5 ,backgroundColor: MyColors.bluecolor,child: Icon(Icons.check,color: Colors.black,size: 8,),),
                ...
                Row(
                  children: [
                    ...
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text("vijay thalapathy",style: TextStyle(color:  MyColors.whitecolor),),
                        Text("Followed...",
                            style: TextStyle(color:  MyColors.whitecolor))
                      ],
                    ),
              ...
              Column(
                ...
                mainAxisAlignment: MainAxisAlignment.start,crossAxisAlignment: CrossAxisAlignment.start,
                  ...
                  children: [
                  Text("About-Help-Press-API-Jobs-Privacy-Terms.",style:
                   TextStyle(color: MyColors.grey4),),
                 ...
                 Text("Location.Language.Meta Verified",style: TextStyle(color:
                 MyColors.grey4),),
                  SizedBox(height: 20,),
                 ...
                 Container(height: 10,width: 10,decoration: BoxDecoration(borderRadius:BorderRadius.circular(10),border: Border.all(color: const Color.fromARGB(255, 102, 99, 99)) ),child: Center(child: Text("c",style: TextStyle(color:const Color.fromARGB(255, 141, 125, 125),fontSize: 6,fontWeight: FontWeight.bold),)),),
                  ...
                  Text("2025 INSTAGRAM FROM META",style: TextStyle(color:  MyColors.grey4),),
